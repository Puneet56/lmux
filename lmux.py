...
# Intercepts `claude` invocations from inside an lmux pane (LMUX_PANE=1)
# and injects Notification/Stop hooks via --settings so attention events
# route back into lmux via `lmux notify`. Outside lmux panes, passes
# through unchanged.
